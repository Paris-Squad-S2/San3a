...
import com.paris_2.san3a.data.source.remote.requestDetails.RequestDetailsDataSourceImpl
...
val dataModule = module {
    ...
    singleOf(::RequestDetailsDataSourceImpl) { bind<RequestDetailsDataSource>() }
}