...
class GetOffersException() : San3aException("Failed to get offers")
class GetOffersCountException() : San3aException("Failed to get offers count")
class GetCraftsmanOffersException() : San3aException("Failed to get craftsman offers")
